...
const navGroups: { label: string; items: NavItem[] }[] = [
  {
    label: "Overview",
    items: [
      { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["owner", "supervisor", "accountant", "labour"] },
      { href: "/my-tasks", label: "My Tasks", icon: ClipboardList, roles: ["labour"] },
    ],
  },
  {
    label: "Operations",
    items: [
      { href: "/inventory", label: "Inventory", icon: Package, roles: ["owner", "supervisor", "accountant", "labour"] },
      { href: "/orders", label: "Orders", icon: Box, roles: ["owner", "supervisor"] },
      { href: "/production", label: "Production", icon: Wrench, roles: ["owner", "supervisor"] },
      { href: "/cutter", label: "Cutter", icon: Wrench, roles: ["owner", "supervisor"] },
    ],
  },
  {
    label: "Sales",
    items: [
      { href: "/clients", label: "Clients", icon: Users, roles: ["owner", "accountant"] },
      { href: "/invoices", label: "Invoices", icon: FileText, roles: ["owner", "accountant"] },
      { href: "/ewb", label: "E-Way Bill", icon: Truck, roles: ["owner", "accountant"] },
    ],
  },
  {
    label: "People",
    items: [
      { href: "/labour", label: "Labour", icon: Users, roles: ["owner", "supervisor"] },
    ],
  },
  {
    label: "Admin",
    items: [
      { href: "/reminders", label: "Notifications", icon: Bell, roles: ["owner"] },
      { href: "/reports", label: "Reports", icon: FileText, roles: ["owner", "accountant"] },
      { href: "/guidelines", label: "Guidelines", icon: Settings, roles: ["owner", "supervisor", "labour"] },
    ],
  },
];
...
const searchPages = [
  ...
  { href: "/inventory/slabs", label: "Slabs" },
      ...
      <div className="min-h-screen flex bg-[var(--background)]">
              ...
              <div className="relative">
                ...
                {notifOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-80 max-h-96 overflow-y-auto rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--surface)] shadow-[var(--shadow-md)] z-50">
                      <div className="px-4 py-3 border-b border-[var(--border-subtle)] font-medium text-[var(--text-sm)]">
                        Notifications
                      </div>
                      {notifications.length === 0 ? (
                        <p className="p-4 text-[var(--text-sm)] text-[var(--text-muted)]">No notifications</p>
                      ) : (
                        notifications.slice(0, 10).map((n) => (
                          <Link
                            ...
                            className={cn(
                              "block px-4 py-3 border-b border-[var(--border-subtle)] last:border-0 hover:bg-[var(--surface-2)]",
                      ...
                      <Link href="/reminders" className="block px-4 py-2 text-center text-[var(--text-sm)] text-[var(--accent)] hover:bg-[var(--surface-2)]" onClick={() => setNotifOpen(false)}>
                        View all
                      </Link>
                    </div>
                  </>
        ...
        {searchOpen && (
          <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh] p-4">
            ...
            <div className="relative w-full max-w-lg rounded-[var(--radius-xl)] bg-[var(--surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-md)] overflow-hidden">
